...
mean_and_std <- (grepl("activityId" , col_names) | grepl("subjectId" , col_names)|grepl("mean..",col_names)|grepl("std,,",col_names))
...
Data_Activity_Names<-merge(data_mean_std, activityLabels,by="activityId",all.x=TRUE)
